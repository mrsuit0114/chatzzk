...
// 컴포넌트 & 데이터
import { ChannelCard, ChannelCardSkeleton } from "@/features/channel/components/ChannelCard";
        ...
        <div className="container mx-auto py-8">
            ...
            <div className="flex justify-center gap-6">
                ...
                <main className="flex-1 w-full max-w-5xl space-y-8">
                    {/* 검색어가 없을 때의 안내 화면 */}
                    {!query ? (
                        <div className="py-32 flex flex-col items-center justify-center text-muted-foreground space-y-4 border rounded-xl bg-muted/5 border-dashed">
                            <div className="p-4 bg-background rounded-full shadow-sm">
                                <Search className="h-8 w-8 opacity-20" />
                            </div>
                            <p className="text-lg font-medium">채널명 또는 채널 ID를 입력하여 검색해보세요.</p>
                        </div>
                    ) : (
                        <>
                            {/* 페이지 헤더 */}
                            <div className="flex flex-col gap-2 border-b pb-6">
                                ...
                                <div className="flex items-center gap-4 text-sm text-muted-foreground">
                                    ...
                                    <span>
                                        검색된 채널: <span className="font-medium text-foreground">{totalCount.toLocaleString()}개</span>
                                    </span>
                                </div>
                            </div>
